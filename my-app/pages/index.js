...
import { addLiquidity, calculateLPD } from "../utils/addLiquidity";
import {
  getLPDTokenBalance,
  getEtherBalance,
  getLPTokenBalance,
  getReserveOfLPDTokens,
...
export default function Home() {
  ...
  const getAmounts = async () => {
    try {
      ...
      const _cdBalance = await getLPDTokenBalance(provider, address);
      ...
      const _reservedCD = await getReserveOfLPDTokens(provider);
              ...
              <div>
                <input
                  ...
                  onChange={async (e) => {
                    ...
                    const _addCDTokens = await calculateLPD(
                      e.target.value || "0",
